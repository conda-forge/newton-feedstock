About newton-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/newton-feedstock/blob/main/LICENSE.txt)

Home: https://newton-physics.github.io/newton/
...
Development: https://github.com/newton-physics/newton
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/newton-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/newton-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
| --- | --- | --- | --- |
| [![Conda Recipe](https://img.shields.io/badge/recipe-newton-green.svg)](https://anaconda.org/conda-forge/newton) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/newton.svg)](https://anaconda.org/conda-forge/newton) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/newton.svg)](https://anaconda.org/conda-forge/newton) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/newton.svg)](https://anaconda.org/conda-forge/newton) |
...
Installing `newton` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
pixi add newton newton-all newton-examples newton-importers newton-notebook newton-remesh newton-sim
# for installing globally
pixi global install newton newton-all newton-examples newton-importers newton-notebook newton-remesh newton-sim
```
...
It is possible to list all of the versions of `newton` available on your platform:

<details>
<summary>With conda</summary>

```
conda search newton --channel conda-forge
```
...
```
mamba search newton --channel conda-forge
```
...
```
pixi search newton --channel conda-forge
```
...
mamba repoquery search newton --channel conda-forge

# List packages depending on `newton`:
mamba repoquery whoneeds newton --channel conda-forge

# List dependencies of `newton`:
mamba repoquery depends newton --channel conda-forge
```
...
Updating newton-feedstock
=========================

If you would like to improve the newton recipe or build a new
...
Note that all branches in the conda-forge/newton-feedstock are
